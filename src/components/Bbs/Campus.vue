    ...
    <div class="campus">
      ...
      <div class="my">
        ...
        <div class="campus_fun_mine">
          <div>
            <router-link to="/campus/My-questision"
              ><h4>我提问的</h4></router-link
            >
          </div>
          <div>
            <router-link to="/campus/My-propose"><h4>我创作的</h4></router-link>
          </div>
        </div>
      </div>
      <!-- 信息归类 -->
      <div class="information">
        <div class="information_operation">
          <ul>
            <li>
              <router-link to="/people/index/collection">我的收藏</router-link>
            </li>
        ...
        <div class="information_advert">
          <img
            src="../../../static/images/department_propaganda.jpg"
            alt="检测网络"
          />
          <span>广告</span>
        </div>
  ...
  data() {
    return {
      ...
      server: [
        {
          title: "提问",
          img: "../../../static/images/question.png",
          router: "questions"
        },
        {
          title: "文章",
          img: "../../../static/images/campus_article.png",
          router: "article"
        },
        {
          title: "博客",
          img: "../../../static/images/answer.png",
          router: "blod"
        }
      ],
      data: [
        {
          title: "333342323",
          des: "哈哈哈111111111111111111111111111111",
          imgsrc:
