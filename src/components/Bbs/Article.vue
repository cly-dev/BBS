  ...
  <div>
    ...
    <div class="article_main">
      ...
      <div class="article_nature">
        ...
        <p
          class="nature_wran"
          :style="{ color: natureWarn.color }"
          v-show="NatureFlag"
        >
          <span :class="natureWarn.icon"></span>{{ natureWarn.msg }}
        </p>
      </div>
      <!-- 文章内容 -->
    ...
    <!--弹出框提示 -->
    <el-dialog title="温馨提示" :visible.sync="Promptinput" width="30%">
      <span>
        亲爱的创作者,创作不能出现故意辱骂、网暴、贬低他人或者他人家属，不能出现破坏社会的过激和敏感言论,本平台不承担任何法律责任，
        一切后果由本人承担,净化网络环境，人人有责
      </span>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="Promptinput = false"
          >我已知晓</el-button
        >
      </span>
    </el-dialog>
    <el-dialog title="预览" :visible.sync="preview" width="50%" center>
      <div class="preview ql-editor">
        <h1 align="center">标题:{{ formdata.title }}</h1>
...
import { UploadArticle } from "../../api/data";
export default {
  name: "FuncFormsEdit",
  mixins: [upload],
  components: {
