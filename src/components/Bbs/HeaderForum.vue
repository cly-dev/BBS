    ...
    <div class="campus_nav">
      ...
      <div class="nav_field">
        <ul>
          ...
          <li>
            <router-link to="/campus/follow">关注 </router-link>
          </li>
          <li>
                  ...
                  <li v-for="(value, index) in hot_search" :key="index">
                    <div v-if="focusflag == true">
                      <div class="hotsearch_list">
                        <span
                          :style="judgefront(index)"
                          class="hotseach_number"
                          >{{ index + 1 }}</span
                        ><a
                          href="javascript:void(0)"
                          @click="jumptodetails(value)"
                          >{{ value.title }}</a
                        >
                        <span
                          class="hotseach_status"
                          :style="judgingwordBgc(value)"
                          >{{ judgingWord(value) }}</span
                        >
                      </div>
                      <div
                        class="hotsearch_tocomplete hotsearch_list"
                        v-if="index == 8"
                      >
            ...
            <transition enter-active-class="animated fadeIn">
              <div class="person_msg" v-show="show">
                <div>
                  <ul class="msg_header">
                    <li
                      v-for="(title, index) in msg_title"
                      :key="index"
                  ...
                  <div class="centent_natice">
                    ...
                    >
                      ...
                      <div class="information_details">
                        <span
                          >来自<ins style="pointer-events: none;">{{
                            list.title
                          }}</ins
                          >的消息</span
                        >
          ...
          <li>
            <el-popover placement="bottom" width="50" trigger="click">
              <div class="person_setting">
                <ul>
                  <li><router-link to="/people"> 我的主页</router-link></li>
                  <li>退出</li>
                </ul>
              </div>
              <img
                :src="$store.state.user.selfImage"
                alt="请检查网络"
                class="person_photo"
                slot="reference"
              />
