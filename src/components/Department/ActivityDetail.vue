      ...
      <div class="ActivityDetail_img">
        <div class="img_container">
          <el-carousel height="400px" direction="vertical" :autoplay="false">
            <el-carousel-item v-for="item in data.imageList" :key="item">
              <img :src="item" alt="" class="activity_img" />
            </el-carousel-item>
          </el-carousel>
        </div>
      </div>
      ...
      <div class="ActivityDetail_info">
        ...
        <div class="ActivityDetail_data">
          ...
          <div class="ActivityDetail_btn">
            <el-button
              type="primary"
              :disabled="DisabledFlay()"
              @click="handleSingUp(data)"
              >{{ JoinFlay() }}</el-button
            >
...
export default {
  ...
  async created() {
    ...
    result ? (this.data = result["data"].result) : "";
    console.log(result);
  }
};
</script>
