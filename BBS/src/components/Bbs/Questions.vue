              ...
              this.$refs[formName].validate(valid=> {
                if (valid) {
                  if(this.checkEditor()){
                    ...
                    // this.$axios({
                    //   url:" http://localhost:8080/question/uploadQuestion",
                    //   method:"POST",
                    //   params:{
                    //     title:this.ruleForm.questionname,
                    //     content:this.ruleForm.desc,
                    //     question_image:this.imageUrl,
                    //     label1:this.ruleForm.type[0],
                    //     label2:this.ruleForm.type[1],
                    //     label3:this.ruleForm.type[2],
                    //     label4:this.ruleForm.type[3]
                    //   }
                    // }).then((res)=>{
                    //   console.log(res.data);
                    //   localStorage.setItem("question",JSON.stringify(this.ruleForm));
                    ...
                    //     })
                    //     this.$router.push({
                    //       name:"questdetail",params:{router:'question'}
                    //     })
                    //   }else{
                    //     this.$message({
                    //       message:"创建失败",
