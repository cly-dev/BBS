      ...
      <div class="campus_nav">
        ...
        <div class="nav_field">
             ...
             <el-input
              ...
              <div class="nav_result" v-show="search_result">
                  ...
                  <div class="result_list">
                      <ul>
                        <li v-for="(value,index) in hot_search" v-if="focusflag==true">
                        ...
                        <li v-for="(value,index) in searchlist" :accesskey="index" v-if="focusflag!=true" class="result_data" @click="searchData(value)"><span>{{index+1}}</span>{{value.title}}</li>
                      </ul>
                  </div>
                </div>
              </div>
          ...
          <div class="nav_person">
            <ul class="person_fun">
              <li>
                  <i class="el-icon-bell"  @click="getshow()"></i>
                  <transition
                  enter-active-class="animated fadeIn"
                  >
                  <div class="person_msg" v-show="show">
                    <div>
                      <ul class="msg_header">
                          <li v-for="(title,index) in msg_title" @click="doActive(index)" :class="{active:current==index},title"><i :class="title"></i></li>
                      </ul>
                    </div>
                    <div class="msg_centent">
                      <div class="centent_natice">
                          <div v-for="(list,index) in msglist" class="natice_information">
              ...
              <li>
                  <img src="../../dist/static/images/user.png" alt="请检查网络" class="person_photo">
              </li>
            </ul>
          </div>
          <!-- 消息框 -->
...
<script>
  ...
  export default{
    ...
    mounted(){
      ...
      let msg_icon=document.querySelector(".el-icon-bell");
